...
Unlike **PDF**, **EPUB**, and **MHTML**, this format is *very* easy to create, and the browser will apply some extra restrictions on what it can do (for security reasons, so users can trust it).
