...
The browser would also block resources that are not in the ZIP file, which should be possible with existing functionality (where the [sub-origin](https://w3c.github.io/webappsec-suborigins/) proposal will work with this as well).
